...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_newbie_config,
            commands::save_newbie_config,
            commands::get_newbie_status,
            commands::bind_invite,
            commands::run_newbie_for_account,
            commands::run_newbie_all,
            commands::claim_all_newbie_tasks,
            commands::get_newbie_logs,
            commands::autotask_status,
            commands::autotask_probe,
            commands::autotask_run,
