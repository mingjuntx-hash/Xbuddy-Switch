//! xbuddy-switch CLI：npm 安装形态的入口。
//!
//! ```bash
//! xbuddy-switch              # 启动本地服务 + 打开浏览器 webui
//! xbuddy-switch serve        # 只起服务不开浏览器（--port / --no-open）
//! xbuddy-switch status       # 终端输出当前账号
//! xbuddy-switch version      # 版本号
//! ```
