...
#   arch: aarch64 | x64
#   .app 路径默认 target/release/bundle/macos/XBuddy-Switch.app
...
V=$1
ARCH=$2
APP=${3:-target/release/bundle/macos/XBuddy-Switch.app}
...
OUT="XBuddy-Switch_${V}_${ARCH}.dmg"
TMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/xbuddy-switch-dmg.XXXXXX")
TMP_OUT="$TMP_DIR/$OUT"
